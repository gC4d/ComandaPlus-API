...
namespace UnitTests.Domain
{
    public class UserTests
    {
        ...
        {
            Action action = () => new User("John Doe", "john.doe@example.com",  UserStatus.Active, UserRole.Admin, DateTime.Now, DateTime.Now);
        ...
        {
            Action action = () => new User(string.Empty, "john.doe@example.com", UserStatus.Active, UserRole.Admin, DateTime.Now, null);
        ...
        {
            Action action = () => new User("John Doe", "invalid-email" , UserStatus.Active, UserRole.Admin, DateTime.Now, DateTime.Now);
        ...
        {
            var user = new User("John Doe", "john.doe@example.com",  default, UserRole.Admin, DateTime.Now, DateTime.Now);
